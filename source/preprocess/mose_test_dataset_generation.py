...
from preprocess.general_utils import *
import time
...
for t in tqdm(test_smiles.SMILES):
    try:
        ...
        if p:
            ...
            test_mols_artificial.append(None)
...
test_mol_df['smiles_nostereo'] = [rdkit.Chem.MolToSmiles(m, isomericSmiles = False) for m in test_mols]
...
test_mol_df.to_pickle('../data/MOSES2/MOSES_test_database_mol.pkl')
